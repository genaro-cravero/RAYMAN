class Scene7 extends Phaser.Scene {
  ...
  create() {
    ...
    escuela = this.physics.add
      .image(20611, 300, "puerta")
      .setScale(1, 5)
      .setAlpha(0.01);
    ...
    //// SCORE
    scoreText = this.add
      .bitmapText(320, -2, "pixel", "PUNTAJE: 0", 50)
      .setTint(0x000000);
    ...
    this.physics.pause();
    pausacont = 1;
    instrucciones = this.add
      .image(0, 0, "instrucciones2")
      .setOrigin(0, 0)
      .setScale(1.12, 0.9)
      .setInteractive()
      .on("pointerdown", () => {
  ...
  gameOver() {
    ...
    this.add
      .bitmapText(player.x - 150, 300, "pixel", "PERDISTE", 70)
      .setTint(0xd10d06);
    var gameOverButton = this.add
      .bitmapText(player.x + 200, 500, "pixel", "Continuar", 50)
      .setTint(0xffffff)
      .setInteractive()
      .on("pointerdown", () => {
        pausacont = 0;
    ...
    Phaser.Display.Align.In.Center(
      gameOverButton,
      this.add.zone(player.x + 200, 500)
    );
  }
  pausa() {
    ...
    pausa = this.add
      .image(player.x, 500, "pausafondo")
      .setScale(1.5)
      .setAlpha(0.8);
    pausa2 = this.add.image(player.x, 500, "pausamadera");
    reanudartext = this.add
      .bitmapText(player.x - 170, 300, "pixel", "Reanudar", 60)
      .setTint(0x21911d)
      .setInteractive()
      .on("pointerdown", () => {
        this.physics.resume();
        reanudartext.destroy();
        pausa.destroy();
        pausa2.destroy();
        pausacont = 0;
    ...
    restartButton = this.add
      .bitmapText(player.x - 190, 470, "pixel", "Reiniciar", 60)
      .setTint(0x63370a)
      .setInteractive()
      .on("pointerdown", () => this.reiniciar());
    menu = this.add
      .bitmapText(player.x - 115, 620, "pixel", "Salir", 60)
      .setTint(0xecd313)
      .setInteractive()
